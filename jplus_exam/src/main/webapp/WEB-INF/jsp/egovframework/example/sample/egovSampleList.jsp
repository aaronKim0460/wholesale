...
<head>
    ...
    <script type="text/javaScript" language="javascript" defer="defer">
	    ...
	    $(document).ready(function () {
			...
			//alert(Base64.encode("Basic 81010a1f-e729-4883-8aa4-287528dbe983")); // 인코딩되어 7JWI64WV7ZWY7IS47JqU 출력됨
			//alert(Base64.decode("Basic 81010a1f-e729-4883-8aa4-287528dbe983")); // 디코딩되어 안녕하세요 출력됨
			...
			$.ajax({                                                  
				...
				headers     : { "Authorization": "Basic YXNkOjgxMDEwYTFmLWU3MjktNDg4My04YWE0LTI4NzUyOGRiZTk4Mw==","Content-Type": "application/json"},
				type        : 'POST',
				dataType    : 'json',
				data        : json_data ,
